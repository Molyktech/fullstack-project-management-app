...
export class WorkspaceService {
    ...
    //**************** **************/
    public createWorkspaceService = async (
        userId: string,
        body: {
            name: string;
    ...
    public getAllWorkspacesUserIsMemberService = async (userId: string) => {
    ...
    public getWorkspaceByIdService = async (workspaceId: string) => {
    ...
    public getWorkspaceMembersService = async (workspaceId: string) => {
    ...
    public getWorkspaceAnalyticsService = async (workspaceId: string) => {
    ...
    public changeMemberRoleService = async (
        workspaceId: string,
        memberId: string,
        roleId: string
    ) => {
    ...
    // UPDATE WORKSPACE
    //**************** **************/
    public updateWorkspaceByIdService = async (
        workspaceId: string,
        name: string,
        description?: string
    ) => {
    ...
    public deleteWorkspaceService = async (
        workspaceId: string,
        userId: string
    ) => {
        const session = await mongoose.startSession();
